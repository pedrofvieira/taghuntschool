...
package br.cin.ufpe.taghuntschool.comparator;

import java.util.Comparator;

import br.cin.ufpe.taghuntschool.domain.StudentMissionStep;

public class StudentMissionStepComparator implements Comparator<StudentMissionStep>{

	@Override
	public int compare(StudentMissionStep object1, StudentMissionStep object2){
		if(object1.getOrd() < object2.getOrd()){
			return -1;
		}
		if(object1.getOrd() > object2.getOrd()){
			return 1;
