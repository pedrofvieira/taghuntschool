...
package br.cin.ufpe.taghuntschool.exception;

public class ExceptionTaghuntSchool extends Exception {

	private static final long serialVersionUID = 1L;
	
	public ExceptionTaghuntSchool(String msg){
		super(msg);
	}
	
	public ExceptionTaghuntSchool(){
		super();
	}
