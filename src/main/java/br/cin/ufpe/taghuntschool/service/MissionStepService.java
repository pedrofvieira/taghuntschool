...
import br.cin.ufpe.taghuntschool.dao.MissionStepDAO;
...
public class MissionStepService {
	...
	@Autowired
	@Inject
	MissionStepDAO missionStepDAO;

	public MissionStep findByThingName(String thingName) {
		return missionStepDAO.findByThingName(thingName);
	}
	
	public MissionStep findByThingKey(String thingKey) {
		return missionStepDAO.findByThingKey(thingKey);
	}
}
